   ...
   function loadOnDemand(func)
    {
        if(state.allImagesLoaded == null)
        {
          ...
          $.when(
              ...
              state.imageSrcs =["../data/lightning_images/lightningONT/lightningONT_1.png","../data/lightning_images/lightningONT/lightningONT_2.png","../data/lightning_images/lightningONT/lightningONT_3.png","../data/lightning_images/lightningONT/lightningONT_4.png","../data/lightning_images/lightningONT/lightningONT_5.png","../data/lightning_images/lightningONT/lightningONT_6.png","../data/lightning_images/lightningONT/lightningONT_7.png"];
