    ...
    function loadOnDemand(func)
    {
        if(state.allImagesLoaded == null)
        {
          ...
          $.when(
              ...
              state.imageSrcs =["../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_1.gif","../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_2.gif","../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_3.gif","../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_4.gif","../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_5.gif","../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_6.gif","../data/radar/detailed/cad_thunder/CN_RADAR_THUNDER_7.gif"];
